...
class RobotControl(object):
    ...
    def _condition(self, condition, out1, out2):
...
class Program(object):
    ...
    def program2(self, out1, out2): 
        return partial(self._progn, out1, out2)

    def program3(self, out1, out2, out3):     
...
if __name__ == "__main__":
    ...
    # Defining population and hall of fame variables
    population = toolbox.population(n=400)
    hall_of_fame = tools.HallOfFame(1)

    # Registering the statistics
    stat = tools.Statistics(lambda x: x.fitness.values)
    ...
    probability_mutate = 0.3
    num_generations = 50
    
    # Running the algorithm to solve the problem
    algorithms.eaSimple(population, toolbox, probability_crossover, 
            probability_mutate, num_generations, stat, 
