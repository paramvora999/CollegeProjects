# Loading historical stock quotes from matplotlib package for this example code. Work done with pre-defined data for multiple portfolios and a BMG based business model.
